...
/**
 * This trait holds if type T is callable, i.e. if an element of type T
 * can be called with any kind of parameter types.
 *
 * Due to this StackOverflow post:
 * http://stackoverflow.com/a/15396757/1593077
 */
template<typename T>
struct is_callable
    : std::conditional<
...
/*
 * Member existence checker trait - for any member, using a macro for defining the trait.
 * Code lifted from here:
 * http://stackoverflow.com/a/14523787/1593077
 */
...
/**
 * An extension of std::is_same to sets of possible values, i.e.
 * the value is true if the first type is the same as any of the other
 * types.
 */
...
//--------------------------------------
//
// For here on in this file - contents is
