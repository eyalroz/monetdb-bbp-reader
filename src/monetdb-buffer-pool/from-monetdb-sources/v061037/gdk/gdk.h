...
/* #define BBPstatus(bbp, i)	(BBPcheck((i),"BBPstatus")?BBP_status(bbp, i):-1) */
/* #define BBPrefs(bbp, i)	(BBPcheck(bbp, (i),"BBPrefs")?BBP_refs(i):-1) */
/* #define BBPcache(bbp, i)	(BBPcheck((i),"BBPcache")?BBP_cache(bbp, i):(BAT*) NULL) */
...
/* Eyal says: Pulled from somewhere else... I think. Do we need this? */
