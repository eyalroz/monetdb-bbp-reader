...
/*
 * Note: In MonetDB's actual gdk_atoms.c , the time-related definitions are _not_
 * included (i.e.t he following line doesn't exist), since they're a MAL module.
 */
...
atomDesc BATatoms[MAXATOMS] = {
	[TYPE_void] = {
		...
		.atomCmp = (int (*)(const void *, const void *)) NULL,
		.atomHash = (BUN (*)(const void *)) NULL,
#else
		...
		.atomRead = (void *(*)(void *, stream *, size_t)) NULL,
		.atomWrite = (gdk_return (*)(const void *, stream *, size_t)) NULL,
	},
	[TYPE_bit] = {
		.name = "bit",
		.storage = TYPE_bte,
		...
		.atomFromStr = (ssize_t (*)(const char *, size_t *, void **, bool)) NULL,
			/* TODO: This field is non-null for other types; why not "bit" as well? */
		.atomToStr = (ssize_t (*)(char **, size_t *, const void *, bool)) NULL,
		.atomRead = (void *(*)(void *, stream *, size_t)) NULL,
		.atomWrite = (gdk_return (*)(const void *, stream *, size_t)) NULL,
		.atomCmp = (int (*)(const void *, const void *)) NULL,
		.atomHash = (BUN (*)(const void *)) NULL,
	...
	[TYPE_bat] = {
		...
		.size = sizeof(bat),
		.atomNull = (void *) &int_nil,
		/* TODO: Is it useful to actually support BATs as data types and have batFromStr here? */
		.atomFromStr = (ssize_t (*)(const char *, size_t *, void **, bool)) NULL,
		.atomToStr = (ssize_t (*)(char **, size_t *, const void *, bool)) NULL,
		.atomRead = (void *(*)(void *, stream *, size_t)) NULL,
		.atomWrite = (gdk_return (*)(const void *, stream *, size_t)) NULL,
		.atomCmp = (int (*)(const void *, const void *)) NULL,
		.atomHash = (BUN (*)(const void *)) NULL,
		.atomFix = (int (*)(const void *)) NULL,
		.atomUnfix = (int (*)(const void *)) NULL,
	},
	[TYPE_int] = {
		.name = "int",
		.storage = TYPE_int,
...
#endif
		.atomFromStr = (ssize_t (*)(const char *, size_t *, void **, bool)) OIDfromStr,
		/* Why do we need a toStr here, when other atoms don't have it? */
		.atomToStr = (ssize_t (*)(char **, size_t *, const void *, bool)) OIDtoStr,
	},
	[TYPE_ptr] = {
		.name = "ptr",
	...
	[TYPE_str] = {
		...
		.atomHeap = NULL, /* TODO: Perhaps we need this? */
	},
	/*
	 * Note: The following entries do not exist in MonetDB's actual gdk_atoms.c ,
	 * and are added dynamically (?) somewhere else in the source, as time-related types
	 * are a MAL module
	 */
	[TYPE_date] = {
		.name = "date",
		...
		.atomFromStr = (ssize_t (*)(const char *, size_t *, ptr *, bool)) date_fromstr,
		.atomToStr = (ssize_t (*)(str *, size_t *, const void *, bool)) date_tostr,
		.atomRead = (void *(*)(void *, stream *, size_t)) NULL,
		.atomWrite = (gdk_return (*)(const void *, stream *, size_t)) NULL,
		.atomCmp =  (int (*)(const void *, const void *)) NULL,
		.atomHash = (BUN (*)(const void *)) NULL
	...
	[TYPE_daytime] = {
		...
		.size = sizeof(daytime),
		.atomNull = (ptr) &int_nil,
		.atomFromStr = (ssize_t (*)(const char *, size_t *, ptr *, bool)) daytime_fromstr,
		.atomToStr = (ssize_t (*)(str *, size_t *, const void *, bool)) daytime_tostr,
		.atomRead = (void *(*)(void *, stream *, size_t)) NULL,
		.atomWrite = (gdk_return (*)(const void *, stream *, size_t)) NULL,
		.atomCmp =  (int (*)(const void *, const void *)) NULL,
		.atomHash = (BUN (*)(const void *)) NULL
	...
	[TYPE_timestamp] = {
		.name = "timestamp",
		.storage = TYPE_timestamp,
		.linear = true,
		.size = sizeof(timestamp),
		.atomNull = (ptr) &ts_nil.ts,
		.atomFromStr = (ssize_t (*)(const char *, size_t *, ptr *, bool)) timestamp_fromstr,
		.atomToStr = 	 (ssize_t (*)(str *, size_t *, const void *, bool)) timestamp_tostr,
		.atomRead = (void *(*)(void *, stream *, size_t)) NULL,
		.atomWrite = (gdk_return (*)(const void *, stream *, size_t)) NULL,
		.atomCmp = (int (*)(const void *, const void *)) NULL,
		.atomHash = (BUN (*)(const void *)) NULL
